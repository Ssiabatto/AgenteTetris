...
```
AgenteTetris/
├─ main.py                 # Primary entry point: capture → preprocess → Tetris processor
├─ __main_.py              # Offline testing: score/print piece landings
├─ requirements.txt        # Python dependencies
├─ CHANGELOG.md            # Release history (v1.0.0 is the first functional delivery)
├─ README.md               # Project overview (this file)
├─ DatedTestVideos/        # Demo recordings (e.g. v1_0_0.mp4)
└─ src/                    # Source packages
   ├─ tetris/              # Core Tetris logic (pieces, board, heuristics)
   ├─ video/               # Screen capture & preprocessing
   ├─ matrix/              # Image → numeric matrix utilities
   └─ AIBot/               # Experimental AI/brain code
```
...
See [CHANGELOG](CHANGELOG.md) for version history. The initial release entry is dated 2024-11-04.
